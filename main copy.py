...
def draw_lines():
    pygame.draw.line(screen,'#000000',(100,0),(100,300),10)
    pygame.draw.line(screen,'#000000',(200,0),(200,300),10)
    pygame.draw.line(screen,'#000000',(0,100),(300,100),10)
    pygame.draw.line(screen,'#000000',(0,200),(300,200),10)
...
def render():
    ...
    class CellClass():
        def __init__(self,pos,x,y):
            self.label = pygame.font.SysFont('Monospace',100).render(pos_list[pos],1,'#000000')
            self.xpos = x
            self.ypos = y
